...
/**
 * Class containing methods to be used when saving object in Parse DO NOT USE PARSE METHOD saveEventually/deleteEventually:
 * 
 * ParseCommandCache.runLoop() is the thread that processes any items from previous calls to saveEventually that haven't yet been saved to Parse's servers. If you haven't been calling saveEventually, then this thread will be asleep, and will only be awakened when you do call it. This thread causes UI to block.
 * 
 * @author Silvia
 *
 */
public class ParseUtils {
	...
	public static void saveMicrogoal(ParseObject p_microgoal, final Microgoal l_microgoal) {
		System.out.println("save " + p_microgoal.getObjectId());
	...
	public static void deleteMicrogoal(ParseObject p_microgoal, final Microgoal microgoal) {
		System.out.println("delete " + p_microgoal.getObjectId());
