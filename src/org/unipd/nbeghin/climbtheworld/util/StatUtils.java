...
//		}
	...
	public static List<Stat> calculateStats() {
		...
		try {
			...
			Building building = ClimbTheWorldApp.buildingDao.queryForId(Integer.valueOf(building_id));
	...
	private static String execQuery(String sql) throws SQLException, NoStatFound {
		GenericRawResults<String[]> rawResults = ClimbTheWorldApp.climbingDao.queryRaw(sql);
