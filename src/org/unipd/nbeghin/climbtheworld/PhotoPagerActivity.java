 ...
 */
public class PhotoPagerActivity extends BaseImageLoaderActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		int pagerPosition = bundle.getInt("imagePagerPosition", 0);
	...
	private class ImagePagerAdapter extends PagerAdapter {
		...
		ImagePagerAdapter(List<Photo> images) {
			this.images = images;
